...
execute @e[type=armor_stand,name=OthelloOrigin] ~ ~7 ~1 setblock ~ ~ ~ minecraft:structure_block 1 replace {name:"OthelloLogic",rotation:"NONE",mirror:"NONE",mode:"LOAD",ignoreEntities:1b}
execute @e[type=armor_stand,name=OthelloOrigin] ~ ~8 ~1 setblock ~ ~ ~ redstone_block 0
