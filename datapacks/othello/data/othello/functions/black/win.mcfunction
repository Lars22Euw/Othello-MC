...
execute as @a[tag=OthelloSetup] at @s run gamemode 1 @s[tag=dev]
...
tag @a[tag=OthelloSetup] remove Black
tag @a[tag=OthelloSetup] remove White
tag @a[tag=OthelloSetup] remove OthelloSetup
#(gibts nicht mehr) gamerule gameLoopFunction othello:lobby
