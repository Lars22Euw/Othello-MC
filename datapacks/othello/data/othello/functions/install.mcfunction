...
tellraw @p ["Othello for Minecraft 1.13+ by ",{"text":"Lars22","color":"blue","underlined":true,"clickEvent":{"action":"open_url","value":"https://github.com/Lars22Euw/Othello-MC"}},{"text":" and ","color":"none","underlined":false},{"text":"DragonGamesDev","color":"blue"},{"text":". Build by ","color":"none"},{"text":"TheLordCthulhu","color":"blue"},{"text":".","color":"none"}]
